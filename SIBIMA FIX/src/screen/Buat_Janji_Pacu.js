...
const Buat_Janji_Pacu = ({ navigation }) => {
  ...
  const schedules = {
    ...
    Chat: [
      ...
      { name: 'SIREG A', info: ['Zahra Tri Zafira', 'Semester 5']},
      { name: 'SIREG A', info: ['Cheisya Andini Bahri', 'Semester 5']},
      { name: 'SIREG A', info: ['Pratiwi Ayuningtiyas', 'Semester 5']},
    ],
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Buat Janji</Text>
      ...
      <View style={styles.profileSection}>
        <Image source={require('../../Assetsibima/Pacu.png')} style={styles.avatar} />
        <View style={styles.profileInfo}>
          <Text style={styles.profileName}>Pacu Putra Suarli, M. SC</Text>
          <View style={styles.profileDetail}>
            <Ionicons name="school" size={14} color="red" />
            <Text style={styles.profileDetailText}>Master Of Science</Text>
          </View>
          <View style={styles.profileDetail}>
            <Ionicons name="ribbon" size={14} color="red" />
            <Text style={styles.profileDetailText}>7 Years</Text>
          </View>
          <View style={styles.profileDetail}>
...
export default Buat_Janji_Pacu;
