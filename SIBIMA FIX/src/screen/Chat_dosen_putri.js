...
const Chat_dosen_putri = ({navigation}) => {
    return (
          ...
          <View style={styles.content}>
            <View style={[styles.card, styles.cardRight]}>
              ...
              <View style={styles.cardBottomWhite}>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('Janji_bimbingan_diterima')} style={[styles.button, styles.buttonBlue]}>
                  <Text style={styles.buttonText}>Priksa Sekarang</Text>
                </TouchableOpacity>
              </View>
            </View>
...
export default Chat_dosen_putri;
