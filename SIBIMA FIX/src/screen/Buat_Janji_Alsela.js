...
const Buat_Janji_Alsela = ({ navigation }) => {
  ...
  const schedules = {
    ...
    Chat: [
      ...
      { name: 'SIREG A', info: ['Jeon Wonwoo', 'Semester 2']},
      { name: 'SIREG A', info: ['Lee Jehoon', 'Semester 2']},
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileSection}>
        <Image source={require('../../Assetsibima/Alsella.png')} style={styles.avatar} />
        <View style={styles.profileInfo}>
          <Text style={styles.profileName}>Alsela meiriza, M.T</Text>
          ...
          <View style={styles.profileDetail}>
            ...
            <Text style={styles.profileDetailText}>5 Years</Text>
          </View>
          <View style={styles.profileDetail}>
...
export default Buat_Janji_Alsela;
