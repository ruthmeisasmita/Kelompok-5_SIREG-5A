...
const Buat_Janji_Endang = ({ navigation }) => {
  ...
  const schedules = {
    ...
    Chat: [
      ...
      { name: 'SIBIL B', info: ['Jeon Wonwoo', 'Semester 4']},
      { name: 'SIREG A', info: ['Lee Jehoon', 'Semester 4']},
      { name: 'SIBIL A', info: ['Jake Sim', 'Semester 2']},
      { name: 'SIREG C', info: ['Lee Jeonghan', 'Semester 2']},
    ],
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profileSection}>
        <Image source={require('../../Assetsibima/Endang.png')} style={styles.avatar} />
        <View style={styles.profileInfo}>
          <Text style={styles.profileName}>Endang Lestari Ruskan, M. T</Text>
          ...
          <View style={styles.profileDetail}>
            ...
            <Text style={styles.profileDetailText}>9 Years</Text>
          </View>
          <View style={styles.profileDetail}>
...
export default Buat_Janji_Endang;
